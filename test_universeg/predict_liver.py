...
def get_support_patches(support_images, support_labels, patch_size=(64, 64)):
...
@torch.no_grad()
def model_patches_inferer(image, model, support_images_patches, support_labels_patches):
